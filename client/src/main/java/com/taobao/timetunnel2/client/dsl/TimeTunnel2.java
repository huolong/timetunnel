...
/**
 * define most of operations for interact with TimeTunnel
 * 
...
public abstract class TimeTunnel2 {
	...
	/**
	 * convert a message to String use default Charset
	 * 
	 * @param m
	 *            Message
	...
	/**
	 * use a Charset according to name
	 * 
	 * @param name
	 */
	 ...
	 * this tunnel is compress false, sequence false, timeout 1800s, max receive
	 * size 200
	 * 
	 * @param category
	 *            tunnel's name
	...
	private static void post(final Message message, final Tunnel tunnel) {
		if (stoped.get())
	...
	private static void offer(final Message message, final Tunnel tunnel) {
		if (stoped.get())
	 ...
	 * @return future for this sub, use it get message
	 */
	public static SubscribeFuture subscribe(final Tunnel tunnel) {
		if (tunnel == null) {
			throw new IllegalArgumentException("null tunnel");
		}
